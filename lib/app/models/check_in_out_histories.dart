...
class CheckInCheckOutHistoryElement {
  ...
  factory CheckInCheckOutHistoryElement.fromJson(Map<String, dynamic> json) => CheckInCheckOutHistoryElement(
    ...
    refundAmount: json["refundAmount"] == null ? 0.0 :double.parse(json["refundAmount"].toString()),
        ...
        travelCost: json["travel_cost"] == null ? 0.0 : double.parse(json["travel_cost"].toString()),
        employeePaymentStatus: json["employeePaymentStatus"] == null ? false : json["employeePaymentStatus"],
        tips: json["tips"] == null ? 0.0 : double.parse(json["tips"].toString()),
