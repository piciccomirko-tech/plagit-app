...
class CheckInCheckOutDetails {
  ...
  factory CheckInCheckOutDetails.fromJson(Map<String, dynamic> json) => CheckInCheckOutDetails(
        ...
        id: json["_id"],
        clientCheckInTime: json["clientCheckInTime"] == null || json["clientCheckInTime"] == "Invalid date" ? null : DateTime.parse(json["clientCheckInTime"]),
        clientCheckOutTime: json["clientCheckOutTime"] == null || json["clientCheckOutTime"] == "Invalid date"
            ? null
            : DateTime.parse(json["clientCheckOutTime"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "serverAutoCheckOut": serverAutoCheckOut,
