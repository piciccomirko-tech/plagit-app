...
extension DatetimeFormat on DateTime {
  ...
  String get dMMM => DateFormat('d MMM').format(this).toString();
...
extension ImageUrl on String {
  String get imageUrl {
    ...
    return "https://d1ew68mie4ej5v.cloudfront.net/public/users/profile/$this";
  }
  // String get imageUrl {
  //   if (isEmpty) return "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png";
  //
...
extension SocialMediaUrl on String {
...
extension RequestMonthListExtension on List<RequestDateModel?> {
  int calculateTotalMonths() {
    int totalMonths = 0;
    ...
    for (var requestDate in this) {
      if (requestDate != null && requestDate.startDate != null && requestDate.endDate != null) {
        ...
        if (startDate != null && endDate != null) {
          ...
          // Total months including the year difference
          totalMonths += (yearDiff * 12) + monthDiff + 1; // Adding 1 to include the current month
        }
      }
    }
    return totalMonths;
