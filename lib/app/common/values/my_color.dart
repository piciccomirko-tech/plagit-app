...
class MyColors {
  ...
  static Color lC6A34F_primaryLight(BuildContext context) => _isLight(context) ? c_C6A34F : white;
  static Color lC6A34F_primaryDark(BuildContext context) => _isLight(context) ? c_DDBD68 : white;
  ...
  ///  color by name
  static const Color primaryLight = c_C6A34F;
  static const Color primaryDark = c_DDBD68;
  static const Color lightGrey = c_A6A6A6;
  static const Color white = c_FFFFFF;
  static const Color black = c_111111;
  static const Color noColor = Colors.transparent;
  static const Color dividerColor = Color(0xff687684);
  static const Color subscriptionTextColor = Color(0xff797878);
  ...
  static const Color c_DDBD68 = Color(0xff3F8E9B);
