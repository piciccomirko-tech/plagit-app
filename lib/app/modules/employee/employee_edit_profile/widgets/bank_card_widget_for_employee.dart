...
class BankCardWidgetForCandidate extends  GetWidget<EmployeeEditProfileController> {
   const BankCardWidgetForCandidate({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() =>  controller.loading.value == true
        ? Center(child: CustomLoader.loading()): controller.uploadPercent.value>0 && controller.uploadPercent.value<100? Text("Uploading ${controller.uploadPercent.value}") 
        : Center(
