...
class EmployeeHeaderWidget extends GetWidget<EmployeeProfileController> {
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Image.asset('assets/icons/ic_followers.png',
                              width: 20, height: 20, color: MyColors.l111111_dwhite(context)),
                          SizedBox(height: 3.w),
                    ...
                    child: Column(
                          ...
                          children: [
                            ...
                            Image.asset('assets/icons/ic_my_social_post.png',
                                width: 20, height: 20, ),
                            SizedBox(height: 3.w),
                            Text(MyStrings.mySocialPost.tr,
                                style: MyColors.c_9A9A9A.medium16,textAlign: TextAlign.center,),
                            SizedBox(height: 2.w),
                            Obx(() => controller
                                        .totalSocialPostDataLoaded.value ==
                                    true
                                ? CupertinoActivityIndicator()
                                : Text("${controller.totalSocialPost.value}",
                                    style: MyColors.l111111_dwhite(context).semiBold20))
                          ]),
                    ),
                  ),
      ...
      Positioned.fill(
        ...
        child: Obx(()=>(Get.find<EmployeeHomeController>()
            .employee
            .value
            .details
            ?.profilePicture ??
            ...
            defaultImagePath: MyAssets.employeeDefault, radius: 80)
            : ProfilePictureWidget(
            height: 80,
            viewOnly: true,
            profilePictureUrl: (Get.find<EmployeeHomeController>()
                .employee
                .value
                .details
                ?.profilePicture ??
