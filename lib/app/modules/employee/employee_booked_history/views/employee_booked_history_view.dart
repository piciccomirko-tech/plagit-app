                  ...
                  return Stack(
                    children: [
                      Container(
                        ...
                        height: ResponsiveHelper.isTab(context)?170:130,
                        width: double.infinity,
                        padding:  EdgeInsets.only(left: 15.sp, top: ResponsiveHelper.isTab(context)?5.sp:0,right:  15.sp, bottom: 30.sp),
                        ...
                        child: Center(
                            child: Text('${bookingDetails.text}+${bookingDetails.text}' ?? '',
                      ...
                      Positioned.fill(
                        ...
                        child: CustomButtons.button(
                            ...
                            fontSize: ResponsiveHelper.isTab(Get.context)?9.sp:15.sp,
