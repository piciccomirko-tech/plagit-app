...
class AdminClientRequestPositionEmployeesView extends GetView<AdminClientRequestPositionEmployeesController> {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            " ${controller.clientRequestDetail.positionName ?? MyStrings.candidates.tr} ${MyStrings.areShowing.tr}",
  ...
  Widget _employeeItem(Employee user) { 
    return Container(
      ...
      height: Get.width>600? 150.h:null,
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: CustomButtons.button(
                      height: Get.width>600?11.h:23.w,
                      text: (user.isHired ?? false)
                          ? controller.hireStatus.value
                          // : user.isSuggested != null && user.isSuggested == true
                          // Get.find<AdminClientRequestController>().detectSuggestedEmployees( user.id?? '')
                          : user.isSuggested != null && user.isSuggested == true
                              ? MyStrings.suggested.tr
                              : MyStrings.suggest.tr
                              ,
                      margin: EdgeInsets.zero,
                      fontSize: Get.width>600?11.sp:13,
            ...
            children: [
              InkWell(
                onTap: () => controller.onEmployeeClick(user),
                  child: _image((user.profilePicture ?? ""))),
              Expanded(
                child: Column(
                  children: [
                    InkWell(
                    ...
                    Row(
                      children: [
                        _detailsItem(MyAssets.rate, MyStrings.rate.tr,
                            "${Utils.getCurrencySymbol()}${user.hourlyRate ?? 0}"),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _image(String profilePicture) => Container(
        ...
        child:  profilePicture.isNotEmpty? CustomNetworkImage(
