              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(widget.messages[index]['message'].text.text[0],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize:17,fontFamily: MyAssets.fontKlavika),),
                      SizedBox(height: 2.w), // Space between message and timestamp
                      Text(
                        timeago.format(DateTime.now()),
                        style: Get.width > 600 ? TextStyle(color: Colors.white,fontSize: 15,fontFamily: MyAssets.fontKlavika) : TextStyle(color: Colors.white,fontSize: 15,fontFamily: MyAssets.fontKlavika),
                      ),
                    ],
                  ),
                ),
