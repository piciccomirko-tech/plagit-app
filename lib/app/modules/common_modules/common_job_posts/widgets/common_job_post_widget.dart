...
class CommonJobPostWidget extends GetView<CommonJobPostsController> {
  final Job jobPost;
  ...
  // final CommonJobPostsController commonJobPostController = Get.find();
  CommonJobPostWidget(
      {super.key,
                ...
                Row(
                  children: [
                    ...
                    _detailsItem(
                        ...
                        context),
                    // if (((appController.user.value.client?.client == true) &&
                    //         (appController.user.value.userId ==
                    //             jobPost.clientId?.id)) ||
                    //     (appController.user.value.admin?.admin == true))
                    if (isMyJobPost)
                      InkResponse(
                        onTap: () =>
                            controller.onEditClick(jobRequest: jobPost),
                        child: CircleAvatar(
                          radius: 12.sp,
                    ...
                    if (isMyJobPost)
                      InkResponse(
                        onTap: () =>
                            controller.onDeleteClick(jobId: jobPost.id ?? ""),
                        child: CircleAvatar(
                          radius: 12.sp,
