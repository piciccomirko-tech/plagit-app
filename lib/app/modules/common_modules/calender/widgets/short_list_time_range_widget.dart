...
class ShortListTimeRangeWidget extends StatelessWidget {
    ...
    return Stack(
      children: [
                    ...
                    child: Row(
                      children: [
                        Checkbox(
                            ...
                            value: Get.find<CalendarController>().sameAsStartDate.value,
                            onChanged: Get.find<CalendarController>().onSameAsStartDatePressedForShortList),
        ...
        Positioned(
            ...
            top: 2.h,
            child: InkWell(
                onTap: () => Get.find<CalendarController>().onRemoveClickForShortList(index: index),
  ...
  Widget _selectTimeRangeWidget({required int index}) {
    return InkWell(
      onTap: () => Get.find<CalendarController>().showTimePickerBottomSheet(index: index),
      child: Container(
