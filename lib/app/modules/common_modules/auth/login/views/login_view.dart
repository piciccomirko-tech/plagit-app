...
class LoginView extends GetView<LoginController> {
        ...
        child: Column(
          children: [
            ...
            CustomButtons.button(
              ...
              fontSize: Get.width>600?12.sp:20.sp,
              height: Get.width>600? 30.h:52.w,
  ...
  Widget get _welcomeBack => Text(
        ...
        style: Get.width > 600
            ...
            : MyColors.l111111_dwhite(controller.context!).semiBold26,
      );
  ...
  Widget get _dontHaveAnAccount => Align(
        ...
        child: Text.rich(
          TextSpan(
            ...
            style: Get.width > 600
                ? MyColors.l50555C_dtext(controller.context!).regular10
                : MyColors.l50555C_dtext(controller.context!).regular16,
            children: [
              TextSpan(
            ...
            Checkbox(
                ...
                side: WidgetStateBorderSide.resolveWith(
                  (Set<MaterialState> states) =>
                      const BorderSide(width: 2.0, color: MyColors.c_C6A34F),
                ),
                value: controller.rememberMe.value,
                onChanged: controller.onRememberMePressed),
            Text(MyStrings.rememberMeText.tr,
                style: Get.width > 600
                    ? MyColors.l111111_dwhite(controller.context!).semiBold10
