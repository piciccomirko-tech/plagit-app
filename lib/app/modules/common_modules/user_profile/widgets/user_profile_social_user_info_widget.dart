...
class UserProfileSocialUserInfoWidget extends GetWidget<UserProfileController> {
  const UserProfileSocialUserInfoWidget({super.key});
              ...
              children: [
                ...
                Obx(() => Positioned(
                    ...
                    child: CircleAvatar(
                      ...
                      child: controller.loadingUserDetails.value
                          ...
                          : ((controller.socialUser.value.profilePicture ?? "")
                                      .isEmpty ||
                                  (controller.socialUser.value.profilePicture ==
                                      "undefined"))
                              ? DefaultImageWidget(
                                  radius: 120,
                                  defaultImagePath:
                                      (controller.socialUser.value.role ?? "")
                                                  .toUpperCase() ==
                                              "EMPLOYEE"
                ...
                Positioned(
                  ...
                  child: Row(
                    children: [
                      Text(
                          controller.socialUser.value.role?.toUpperCase() ==
                                  "EMPLOYEE"
                              ? "CANDIDATE"
                              : controller.socialUser.value.role ?? "",
                          style: MyColors.l111111_dwhite(context).medium13),
                      if ((controller.socialUser.value.positionName ?? "")
                          .isNotEmpty) ...[
                        SizedBox(width: 10.w),
                        const CircleAvatar(
                          radius: 2,
                        ...
                        SizedBox(width: 10.w),
                        Text(
                            (controller.socialUser.value.positionName ?? "")
                                .toUpperCase(),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Get.find<AppController>().user.value.userId ==
                              controller.socialUser.value.id
                          ? Expanded(
                              child: Text(
                                  controller.socialUser.value.name ?? "",
                                  style: MyColors.l111111_dwhite(context)
                                      .semiBold16),
                            )
                          : Text(controller.socialUser.value.name ?? "",
                              style:
                                  MyColors.l111111_dwhite(context).semiBold16),
                      Obx(() => controller.loadingToggleNotification.value
                          ? CupertinoActivityIndicator()
                          : (controller.appController.isFollowing(
                                      controller.socialUser.value.id!) &&
                      ...
                      InkWell(
                          onTap: () {
                            Share.share(DeepLinkService.generateAppLink(
                                "profile/${controller.socialUser.value.id ?? ''}"));
                          },
                          child: Icon(
                            Icons.share,
                            size: 20,
                  ...
                  Row(
                    children: [
                      Text(
                          (controller.socialUser.value.countryName ?? "")
                              .toUpperCase(),
