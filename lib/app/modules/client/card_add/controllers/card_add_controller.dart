...
class CardAddController extends GetxController {
  ...
  void loadWebView({required String sessionId}) {
    String url =
        "https://raw.githack.com/rashedabir/payment-gateway/main/index.html?session_id=$sessionId";
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onPageStarted: (String url) async {
            ...
            } else if (url.startsWith("https://plagit.com/?name=clientHome")) {
              Get.offAllNamed(Routes.clientPremiumRoot);
            } else if (url
                .startsWith("https://plagit.com/?name=clientEditProfile")) {
              Get.offAllNamed(Routes.clientPremiumRoot);
            } else if (url
                .startsWith("https://plagit.com/?name=employeeHome")) {
              Get.offNamed(Routes.employeePlagitPlus);
            } else if (url
                .startsWith("https://plagit.com/?name=employeeEditProfile")) {
              Get.offNamed(Routes.employeeRoot);
            }
          },
