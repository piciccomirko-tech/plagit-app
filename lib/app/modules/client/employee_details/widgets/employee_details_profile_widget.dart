...
class EmployeeDetailsProfileWidget
    extends GetWidget<EmployeeDetailsController> {
  const EmployeeDetailsProfileWidget({super.key});
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _imageBookmark,
          SizedBox(height: 15.w),
          if (!controller.isCandidate) _clientBasic,
          if (controller.isCandidate) _candidateBasicInfo,
          if (controller.isCandidate) SizedBox(height: 15.w),
          if (controller.isCandidate) _skill,
          if (controller.isCandidate) SizedBox(height: 15.w),
          if (controller.isCandidate) _education,
          if (controller.isCandidate) SizedBox(height: 15.w),
          if (controller.isCandidate) _certificate,
          // if (controller.isCandidate) SizedBox(
          //   height: 200,
          //   child: CertificateListWidget(certificates: controller.employee.value.certificates?? [])),
          if (controller.isCandidate) SizedBox(height: 15.w),
          if (controller.isCandidate) language,
          SizedBox(height: 15.w),
          _country,
  ...
  Widget get _clientBasic => !controller.isCandidate
      ? Container(
          ...
          child: Column(children: [
            ...
            _clientRow(
                "Total Rating", "${controller.employee.value.totalRating}"),
                ...
                if (showNotification)
                  Obx(() => controller.loadingToggleNotification.value
                      ...
                      : (controller.appController
                                  .isFollowing(controller.employeeId) &&
                          ...
                          ? Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Icon(
                                  controller.appController
                                          .isNotification(controller.employeeId)
