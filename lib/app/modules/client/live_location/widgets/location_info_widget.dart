                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 5.w),
                        Obx(() => Text("${controller.socketLocationModel.value.distance ?? ""} ${MyStrings.milesAway.tr}",
                            style: MyColors.l111111_dwhite(context).semiBold16)),
                      ],
                    ),
                    SizedBox(height: 5.h),
                    Text(MyStrings.willArriveApproximatelyWithin.tr, style: MyColors.l111111_dwhite(context).medium13),
                  ],
                ),
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(MyStrings.min.tr, style: MyColors.white.medium12),
                    ],
                  ), 
                )
              ],
