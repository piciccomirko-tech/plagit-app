  ...
  Widget build(BuildContext context) {
    return Obx(
      () => CustomTextInputField(
        ...
        label: MyStrings.salaryRange.tr,
        ...
        onTap: () => controller.onCustomSliderClick(
            ...
            minValue: controller.createJobPostRequestModel.value.minRatePerHour?.toString() ?? "0",
            maxValue: controller.createJobPostRequestModel.value.maxRatePerHour?.toString() ?? "0",
