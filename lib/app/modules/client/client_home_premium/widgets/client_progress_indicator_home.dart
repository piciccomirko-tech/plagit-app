...
import '../controllers/client_home_premium_controller.dart';

class ClientProgressIndicatorHomeWidget
    extends GetView<ClientHomePremiumController> {
  final double progress;
  final String message;

  const ClientProgressIndicatorHomeWidget({
    super.key,
