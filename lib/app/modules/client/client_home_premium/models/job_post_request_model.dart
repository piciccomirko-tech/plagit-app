...
class JobPostRequestModel {
  ...
  factory JobPostRequestModel.fromRawJson(String str) =>
      JobPostRequestModel.fromJson(json.decode(str));

  factory JobPostRequestModel.fromJson(Map<String, dynamic> json) =>
      JobPostRequestModel(
        status: json["status"],
...
class Job {
  ...
  factory Job.fromJson(Map<String, dynamic> json) => Job(
        ...
        positionLogo: json["positionLogo"],
