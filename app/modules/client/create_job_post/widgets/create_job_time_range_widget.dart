...
class CreateJobTimeRangeWidget extends StatelessWidget {
  final RequestDateModel requestDate;
  final int index;
  const CreateJobTimeRangeWidget({super.key, required this.requestDate, required this.index});
    ...
    return Stack(
      children: [
                    ...
                    child: Row(
                      children: [
                        Checkbox(
                            ...
                            onChanged: Get.find<CreateJobPostController>().onSameAsStartDatePressed),
        ...
        Positioned(
            ...
            top: 2.h,
            child: InkWell(
                onTap: () => Get.find<CreateJobPostController>().onRemoveClickF(index: index),
  ...
  Widget _selectTimeRangeWidget({required int index}) {
    return InkWell(
      onTap: () => Get.find<CreateJobPostController>().showTimePickerBottomSheet(index: index),
      child: Container(
