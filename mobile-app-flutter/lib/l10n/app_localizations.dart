...
abstract class AppLocalizations {
  ...
  /// In en, this message translates to:
  /// **'Edit'**
  String get jobMenuEdit;

  /// No description provided for @jobMenuPause.
  ///
  /// In en, this message translates to:
  /// **'Pause'**
  String get jobMenuPause;

  /// No description provided for @jobMenuClose.
  ///
  /// In en, this message translates to:
  /// **'Close'**
  String get jobMenuClose;

  /// No description provided for @jobMenuDuplicate.
  ///
  /// In en, this message translates to:
  /// **'Duplicate'**
  String get jobMenuDuplicate;

  /// No description provided for @jobsCountLabel.
  ///
  /// In en, this message translates to:
  /// **'{count,plural, =0{No jobs}=1{1 job}other{{count} jobs}}'**
  String jobsCountLabel(int count);

  /// No description provided for @applicantsCountLabel.
  ///
  /// In en, this message translates to:
  /// **'{count,plural, =0{No applicants}=1{1 applicant}other{{count} applicants}}'**
  String applicantsCountLabel(int count);

  /// No description provided for @activeJobsShort.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 active}other{{count} active}}'**
  String activeJobsShort(int count);

  /// No description provided for @newThisWeekCount.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 new this week}other{{count} new this week}}'**
  String newThisWeekCount(int count);

  /// No description provided for @newApplicantsToReview.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 new applicant to review}other{{count} new applicants to review}}'**
  ...
  /// No description provided for @businessPremiumTitle.
  ///
  /// In en, this message translates to:
  /// **'Business Premium'**
  String get businessPremiumTitle;

  /// No description provided for @hireFasterWithPremium.
  ///
  /// In en, this message translates to:
  /// **'Hire faster with premium tools'**
  String get hireFasterWithPremium;

  /// No description provided for @unlockPowerfulRecruiting.
  ///
  /// In en, this message translates to:
  /// **'Unlock powerful recruiting features'**
  String get unlockPowerfulRecruiting;

  /// No description provided for @benefitQuickPlug.
  ///
  /// In en, this message translates to:
  /// **'Quick Plug — swipe to match top talent'**
  String get benefitQuickPlug;

  /// No description provided for @benefitFeaturedJobs.
  ///
  /// In en, this message translates to:
  /// **'Featured job placements'**
  String get benefitFeaturedJobs;

  /// No description provided for @benefitApplicantInsights.
  ///
  /// In en, this message translates to:
  /// **'Applicant insights & analytics'**
  String get benefitApplicantInsights;

  /// No description provided for @benefitUnlimitedJobs.
  ///
  /// In en, this message translates to:
  /// **'Unlimited job postings'**
  String get benefitUnlimitedJobs;

  /// No description provided for @benefitPriorityVisibility.
  ///
  /// In en, this message translates to:
  /// **'Priority visibility to top candidates'**
  String get benefitPriorityVisibility;

  /// No description provided for @savePercent30.
  ///
  /// In en, this message translates to:
  /// **'Save 30%'**
  String get savePercent30;
  ...
  /// No description provided for @planActiveSuffix.
  ///
  /// In en, this message translates to:
  /// **'{plan} Plan Active'**
  ...
  /// No description provided for @premiumPlanIsActive.
  ///
  /// In en, this message translates to:
  /// **'Your premium plan is active'**
  String get premiumPlanIsActive;
  ...
  /// No description provided for @numberOfPositions.
  ///
  /// In en, this message translates to:
  /// **'Number of Positions'**
  String get numberOfPositions;
  ...
  /// No description provided for @asapChip.
  ///
  /// In en, this message translates to:
  /// **'ASAP'**
  String get asapChip;

  /// No description provided for @specificDateChip.
  ///
  /// In en, this message translates to:
  /// **'Specific Date'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Describe the role, responsibilities and what a typical shift looks like...'**
  String get jobDescriptionHint;

  /// No description provided for @charCountMin.
  ///
  /// In en, this message translates to:
  /// **'{count} / 50 min'**
  ...
  /// No description provided for @benefitsHint.
  ///
  /// In en, this message translates to:
  /// **'List benefits offered (tips, meals, transport, etc.)'**
  ...
  /// No description provided for @featuredJobToggle.
  ///
  /// In en, this message translates to:
  /// **'Featured Job'**
  String get featuredJobToggle;
  ...
  /// No description provided for @publishJobButton.
  ///
  /// In en, this message translates to:
  /// **'Publish Job'**
  String get publishJobButton;

  /// No description provided for @jobPublishedHeadline.
  ///
  /// In en, this message translates to:
  /// **'Job Published!'**
  String get jobPublishedHeadline;

  /// No description provided for @jobPublishedSubtext.
  ///
  /// In en, this message translates to:
  /// **'Your job is now live and visible to candidates'**
  String get jobPublishedSubtext;

  /// No description provided for @postAnother.
  ///
  /// In en, this message translates to:
  /// **'Post Another'**
  ...
  /// No description provided for @noShortlistedHeadline.
  ///
  /// In en, this message translates to:
  /// **'No shortlisted candidates'**
  String get noShortlistedHeadline;

  /// No description provided for @noShortlistedSubtext.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @tabApplicantsCount.
  ///
  /// In en, this message translates to:
  /// **'Applicants ({count})'**
  String tabApplicantsCount(int count);

  /// No description provided for @pauseJobButton.
  ///
  /// In en, this message translates to:
  /// **'Pause Job'**
  String get pauseJobButton;

  /// No description provided for @closeJobButton.
  ///
  /// In en, this message translates to:
  /// **'Close Job'**
  String get closeJobButton;
  ...
  /// No description provided for @sectionRequirements.
  ///
  /// In en, this message translates to:
  /// **'Requirements'**
  ...
  /// No description provided for @labelPosted.
  ///
  /// In en, this message translates to:
  /// **'Posted'**
  String get labelPosted;
  ...
  /// No description provided for @labelSaves.
  ///
  /// In en, this message translates to:
  /// **'Saves'**
  String get labelSaves;

  /// No description provided for @noApplicantsText.
  ///
  /// In en, this message translates to:
  /// **'No applicants yet'**
  String get noApplicantsText;

  /// No description provided for @quickActionShortlist.
  ///
  /// In en, this message translates to:
  /// **'Shortlist'**
  String get quickActionShortlist;

  /// No description provided for @quickActionReject.
  ///
  /// In en, this message translates to:
  /// **'Reject'**
  String get quickActionReject;

  /// No description provided for @quickActionMessage.
  ///
  /// In en, this message translates to:
  /// **'Message'**
