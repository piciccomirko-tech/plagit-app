        ...
        child: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        MockData.candidate['initials'] as String,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text('Waiter', style: TextStyle(fontSize: 13, color: AppColors.secondary)),
                              const SizedBox(height: 2),
                              const Text('Sat, Apr 11 \u00B7 4:09 pm',
            ...
            Padding(
              ...
              child: Text(
                '\u{1F4CD} ${MockData.londonJobs.length} jobs available',
            ...
            SizedBox(
              ...
              child: ListView.separated(
                scrollDirection: Axis.horizontal,
                padding: const EdgeInsets.symmetric(horizontal: 20),
                itemCount: MockData.featuredJobs.length,
                separatorBuilder: (_, __) => const SizedBox(width: 12),
                itemBuilder: (context, i) {
                  final job = MockData.featuredJobs[i];
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Row(
                      children: [
                        _StatCell(count: '3', label: 'Applied', color: AppColors.secondary),
                        SizedBox(width: 8),
                        _StatCell(count: '1', label: 'Under Review', color: AppColors.amber),
                        SizedBox(width: 8),
                        _StatCell(count: '1', label: 'Interview', color: AppColors.teal),
                        SizedBox(width: 8),
                        _StatCell(count: '0', label: 'Offer', color: AppColors.green),
                      ],
                    ),
                  ],
                ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    const Text(
                      'Waiter \u00B7 Sat, Apr 11 \u00B7 4:53 pm \u00B7 Video',
                      style: TextStyle(fontSize: 13, color: AppColors.secondary),
                    ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 2),
                                Text('Tap to view all conversations',
                                    style: TextStyle(fontSize: 12, color: AppColors.secondary)),
                              ],
                            ),
                          ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 14),
                    ...MockData.profileItems.map((item) {
                        ...
                        child: Row(
                          children: [
                            Icon(
                              ...
                              size: 18,
                              color: done ? AppColors.teal : AppColors.tertiary,
                            ),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 13,
                                color: done ? AppColors.charcoal : AppColors.secondary,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Flexible(
                  child: Text(job['contract'] as String? ?? '',
                      style: const TextStyle(fontSize: 10, color: AppColors.secondary),
                      overflow: TextOverflow.ellipsis),
                ),
              ],
            ...
            if (featured || urgent) ...[
              ...
              Row(
                children: [
                  if (featured) _pill('Featured', AppColors.amber),
                  if (featured && urgent) const SizedBox(width: 4),
                  if (urgent) _pill('Urgent', AppColors.red),
                ],
              ),
            ],
          ],
